...
//
//            let propertyKey: String = classMappings[key] != nil ? classMappings[key]!.jsonKey : key
//            
...
//                    
//                    let date = NSDate.dateFromString(dict[mapper.jsonKey]! as! String, format: mapper.dateFormat)
...
//                        
//                        let object: JSONObject = mapper.mClass.alloc() as! JSONObject
...
//                
//            }
//            else if dict.keys.contains(propertyKey) {
//                
...
//        var objects = [T]()
//        
//        for (index, objectJSON): (String, JSON) in json {
//            
